    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand c-navbar-brand p-0" href="/">
                <img class="d-md-none " src="<?php echo img_dir(); ?>/h-binosto-logo.png" alt="logo-2">
                <img class="d-none d-md-block" src="<?php echo img_dir(); ?>/h-binosto-logo.png" alt="logo">
            </a>
    ...
    <div class="c-popup-section" id="c-popup-section-1">
        ...
        <div class="c-popup-wrapper">
            <div class="c-popup-content">
                ...
                <div class="p-logo">
                    <img src="<?php echo img_dir(); ?>/h-binosto-logo.png" alt="logo">
                </div>
                <div class="item">
                    <div class="text">
                        <p>
