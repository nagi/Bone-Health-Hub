...
?>
    ...
    <div class="hero-slider-wrap position-relative">
        <div class="hero-slider-area hero-slider owl-carousel-disabled owl-theme">
            <div class="hero-slider-item bg-binosto c-hero-slider-item">
                <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="feature-thumb">
                        <img src="<?php echo img_dir(); ?>c-thumb-15.png" alt="img-9">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="feature-content">
                        <div class="title">
                            <h4>You have been prescribed Binosto.</h4>
                            <h4>This treatment guide explains what Binosto is, why you have been prescribed it, and how
                                to take it to treat your condition.</h4>
                        </div>
                        <div class="text">
                            <p>
                    ...
                    <div class="faq-section">
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-body">
                                ...
                                <ul>
                                    <li>Sodium dihydrogen citrate</li>
                                    <li>Citric acid anhydrous</li>
                                    <li>Sodium hydrogen carbonate</li>
                                    <li>Sodium carbonate anhydrous</li>
                                    <li>
                                        Strawberry flavour [Maltodextrin (Maize), Arabic gum, Propylene glycol (E 1520),
                                ...
                                <p>
                                    ...
                                    The strawberry flavour comes from corn; the citric acid and monosodium citrate it
                                    contains are made from sugar beet and cane sugar
                                </p>
                            </div>
                        </div>
                        <div class="faq-item">
                            ...
                            <div class="faq-body">
                                <p>
                                    Binosto is suitable for vegetarians and vegans as it does not contain any
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-body">
                                <p>
                                    As osteoporosis is a “silent” condition that you can’t feel, you won’t be able to
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-body">
                                ...
                                <p>
                                    You should continue taking Binosto until your Healthcare Professional advises you to
                                    stop.
                                </p>
                            </div>
                        </div>
